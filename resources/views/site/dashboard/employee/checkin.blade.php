                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="container_check version_2">Sandton
                                                    <input type="checkbox" name="question_1[]" value="Sandton" class="required">
                                                    <span class="checkmark"></span>
                                                </label>
                                            </div>
                                            <div class="form-group">
                                                <label class="container_check version_2">Pretoria
                                                    <input type="checkbox" name="question_1[]" value="Pretoria" class="required">
                                                    <span class="checkmark"></span>
                                                </label>
                                            </div>
                                            <div class="form-group">
                                                <label class="container_check version_2">Cape Town
                                                    <input type="checkbox" name="question_1[]" value="Cape_Town" class="required">
                                                    <span class="checkmark"></span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="container_check version_2">Port Elizabeth
                                                    <input type="checkbox" name="question_1[]" value="Port_Elizabeth" class="required">
                                                    <span class="checkmark"></span>
                                                </label>
                                            </div>
                                            <div class="form-group">
                                                <label class="container_check version_2">Johannesburg CBD
                                                    <input type="checkbox" name="question_1[]" value="Johannesburg" class="required">
                                                    <span class="checkmark"></span>
                                                </label>
                                            </div>
                                            <div class="form-group">
                                                <label class="container_check version_2">None of the above
                                                    <input type="checkbox" name="question_1[]" value="None_Of_The_Above" class="required">
                                                    <span class="checkmark"></span>
                                                </label>
                                            </div>
                                        </div>
                ...
                $.ajax({
                    ...
                    success: function(response)
                    {
                        if(response.status == 'failed'){
                            ...
                            $('#submit').attr("disabled", false);
                            iziToast.success({title: 'Hey!', position: 'center', message: 'Hi we have logged your quiz successfully please close this notification to be redirected to your user menu'});
