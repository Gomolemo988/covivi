                    ...
                    <div class="symptom_instruction_text">
                        ...
                        <p>
                            ...
                            @if($scores > 100 && $scores < 200)
                                ...
                                you maintain safe distance from your colleagues please click <a href="">here</a> to continue unto the workplace check-in page.
                            @endif

                            @if($scores > 200)
                                It appears you have been refused entry into your workplace due to high risk of Covid19 and a risk score of {{ $scores }} please contact your line manager for the way forward and please stay at home during this period.
                            @endif
                        </p>
                    </div>
                </div>
